...
public class SecurityConstants {
    ...
    public static final long EXPIRATION_TIME = 432_000_000; // 5 days (en milliseconde)
    ...
    public static final String[] PUBLIC_URLS = { "/user/login", "/user/register", "/user/image/**", "/user/send-password-reset-link", "/user/reset-password" };
